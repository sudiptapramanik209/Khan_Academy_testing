...
class MobileAppTesting {
  async Explore_Bookmarks() {
    ...
    await el.click();
    await $("//android.widget.Button[5]/android.view.ViewGroup").touchAction(
      "tap"
    );
    ...
    await $(
      '//android.widget.Button[@content-desc="Add Bookmark"][1]/android.widget.ImageView'
    ).touchAction("tap");
    await $('//*[@resource-id="android:id/button2"]').click();
    await driver.pause(3000);
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text("Cryptography challenge 101"))'
    );
    await $(
      '(//android.widget.Button[@content-desc="Add Bookmark"])[2]/android.widget.ImageView'
    ).click();
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text("Modular arithmetic"))'
    );
    ...
    await driver.pause(2000);
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(text("Error correction"))'
    );
    await driver.pause(2000);
    await $(`//android.widget.Button[@content-desc="Add Bookmark"][1]`).click();
  ...
  async Verifying_Deleting_Bookmarks() {
    await $('//android.view.View[@content-desc="Bookmarks"]').touchAction(
      "tap"
    );
    await driver.pause(2000);
    await expect(
      $('//android.widget.TextView[@text="Ancient cryptography"]')
    ).toExist();
    await driver.pause(1000);
    await expect(
      $('//android.widget.TextView[@text="Cryptography challenge 101"]')
    ).toExist();
    await driver.pause(1000);
    await expect(
      $('//android.widget.TextView[@text="Modular arithmetic"]')
    ).toExist();
    await driver.pause(1000);
    await expect(
      $('//android.widget.TextView[@text="Modern information theory"]')
    ).toExist();
    await driver.pause(1000);
    await $('//android.widget.TextView[@text="Edit"]').click();
    await driver.pause(2000);
    await $(
      '(//android.view.ViewGroup[@content-desc="Select bookmark"])[1]/android.widget.ImageView'
    ).click();
    await driver.pause(2000);
    await $(
      '(//android.view.ViewGroup[@content-desc="Select bookmark"])[1]/android.widget.ImageView'
  ...
  async Video_recentLesson() {
    ...
    await driver.pause(2000);
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(text("Recent lessons"))'
    );
  ...
  async Arts_humanities() {
    ...
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text("Early Humans"))'
    ).click();
    ...
    await driver.back();
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text("WATCH: Why Human Evolution Matters"))'
    ).click();
    await driver.pause(15000);
    await driver.back();
    await driver.back();
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text("The Future"))'
    ).click();
    await $(
      'android=new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text("Quiz: Biosphere"))'
    ).click();
